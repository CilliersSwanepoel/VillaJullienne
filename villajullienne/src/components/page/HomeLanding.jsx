            ...
            <div className="feature-overview-container">
                <div className="carousel-text-wrapper reverse">
                    ...
                    <div className="carousel-text fade-in">
                        ...
                        <p className="subheading">Enjoy a peaceful getaway with your loved ones at our family-friendly units, located just minutes from Nelspruit. Thoughtfully designed for comfort and convenience, our accommodations offer a perfect balance of tranquility and access to local attractions.</p>
                    </div>
                </div>
            </div>
        </>
